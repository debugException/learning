 ...
 * MongoTemplate工具类
 * @author szq
 * Date: 2019年1月10日 上午11:35:56
 */
@Component
public class MongodbOperator {

	public static MongodbOperator mongodbOperator;
	
	@PostConstruct
	public void init() {
		mongodbOperator = this;
		mongodbOperator.mongoTemplate = this.mongoTemplate;
	}
	...
	public static void save(Object obj) {
		mongodbOperator.mongoTemplate.save(obj);
	}
	...
	public static void save(Object obj, String collectionName) {
		mongodbOperator.mongoTemplate.save(obj, collectionName);
	}
	...
	public static void remove(Object obj) {
		...
		mongodbOperator.mongoTemplate.remove(obj);
	}
	...
	public static void remove(Object obj, String collectionName) {
		...
		mongodbOperator.mongoTemplate.remove(obj, collectionName);
	}
	...
	public static void removeById(String key, Object value, String collectionName) {
		...
		mongodbOperator.mongoTemplate.remove(query, collectionName);
	}
	...
	public static void updateFirst(String accordingKey, Object accordingValue, String[] updateKeys, Object[] updateValues,
		...
		mongodbOperator.mongoTemplate.updateFirst(query, update, collectionName);
	}
	...
	public static void updateMulti(String accordingKey, Object accordingValue, String[] updateKeys, Object[] updateValues,
		...
		mongodbOperator.mongoTemplate.updateMulti(query, update, collectionName);
	}
	...
	public static List<? extends Object> find(Object obj, String[] findKeys, Object[] findValues) {
		...
		Query query = Query.query(criteria);
		List<? extends Object> resultList = mongodbOperator.mongoTemplate.find(query, obj.getClass());
		return resultList;
	}
	...
	public static List<? extends Object> find(Object obj, String[] findKeys, Object[] findValues, String collectionName) {
		...
		Query query = Query.query(criteria);
		List<? extends Object> resultList = mongodbOperator.mongoTemplate.find(query, obj.getClass(), collectionName);
		return resultList;
	}
	...
	public static Object findOne(Object obj, String[] findKeys, Object[] findValues) {
		...
		Query query = Query.query(criteria);
		Object resultObj = mongodbOperator.mongoTemplate.findOne(query, obj.getClass());
		return resultObj;
	}
	...
	public static Object findOne(Object obj, String[] findKeys, Object[] findValues, String collectionName) {
		...
		Query query = Query.query(criteria);
		Object resultObj = mongodbOperator.mongoTemplate.findOne(query, obj.getClass(), collectionName);
		return resultObj;
	}
	...
	public static List<? extends Object> findAll(Object obj) {
		...
		List<? extends Object> resultList = mongodbOperator.mongoTemplate.findAll(obj.getClass());
		return resultList;
	}
	...
	public static List<? extends Object> findAll(Object obj, String collectionName) {
		...
		List<? extends Object> resultList = mongodbOperator.mongoTemplate.findAll(obj.getClass(), collectionName);
		return resultList;
	}
